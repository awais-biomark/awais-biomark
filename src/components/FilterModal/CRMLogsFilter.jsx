...
const CRMLogsFilter = ({filterPopover, setPopover, buttonList}) => {
    ...
    >
      ...
      <div className={classes.popupButton}>
        {buttonList.map((button, index) => (
          <Button id={button} variant="outlined" className={index === 0 ? classes.activeSortButton : classes.sortButton} key={index}>
            <h4 id={index}>
              {button}
            </h4>
