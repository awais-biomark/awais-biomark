...
const baseURL = "http://127.0.0.1:8000/nextlocations";

const NextLocationsComponent = () => {
        ...
        {post.map((data, index) => (
          <>
            <Box key={index} >
              ...
              <Box onClick={() => handleButton1(index)} sx={{ mb: '8.5px', fontWeight: '400', fontSize: '15px', display: 'flex', justifyContent: 'center', width: '100%' }}>
...
export default NextLocationsComponent;
