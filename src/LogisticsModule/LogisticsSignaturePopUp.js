...
export default function LogisticsSignaturePopUp(props) {
  ...
  return (
    <React.Fragment>
      <Box sx={{ display: 'flex', justifyContent: 'center', mb: '32px' }}>
        <Box sx={{ width: '100%', display: 'flex', justifyContent: 'space-between', marginBottom: '43px', paddingLeft: '10px', paddingRight: '8px' }}>
          ...
          <Button onClick={gotonext} disableRipple variant='text' sx={{ maxWidth: '86px', width: '100%', borderRadius: '8px', ':hover': { bgcolor: '#054E8B' } }} style={nextbuttonStyle}>Confirm</Button>
        </Box>
      </Box>
      <Dialog sx={{
