      ...
      <Container disableGutters maxWidth={false}>
        <Grid container direction='row' justifyContent='center' alignItems='center'  >
          <Box sx={{ width: '100%' }}>
            ...
            <Box sx={{}} elevation='3'>
              <Box className={classes.heading} sx={{ textAlign: 'center', marginTop: '10px', marginBottom: '44px', display: 'flex', justifyContent: 'center', fontWeight: '400', fontSize: '14px', color: '#2A3752', lineHeight: '18.83px' }}>Scan the Clinic QR Code to check into the clinic</Box>
