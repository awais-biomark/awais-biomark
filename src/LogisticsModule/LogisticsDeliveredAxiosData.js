...
const baseURL = "http://127.0.0.1:8000/logisticsdelivered";

const LogisticsDeliveredAxiosData = () => {
        ...
        {post.map((data, index) => (
          <>
            <Box key={index} >
              ...
              <Box onClick={() => handleButton1(index)} sx={{ mb: '8.5px', color: '#111111', fontWeight: '400', fontSize: '15px', display: 'flex', marginTop: '0px', maxHeight: '20px', justifyContent: 'center', lineHeight: '18px', width: '100%' }}>
...
export default LogisticsDeliveredAxiosData;
