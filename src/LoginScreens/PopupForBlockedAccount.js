...
export default function PopipForBlockedAccount(props) {
        ...
        <DialogContent sx={{ '& .MuiDialogContent-root ': { padding: '51px 1px' }, '& .MuiDialog-paper  ': { margin: '1px', width: '20px' } }}>
          <Grid container direction='row' justifyContent='center' alignItems='center'>
            <Box sx={{ boxShadow: '3', paddingBottom: '12px', px: '12px', paddingTop: '17px', borderRadius: '8px', backgroundColor: '#FFFFFF', maxWidth: '351px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <Button onClick={handleClose} disableRipple variant='text' sx={{ ...border_button, width: '100%', borderRadius: '8px', borderColor: '#054E8B', bgcolor: '#ffffff', ':hover': { bgcolor: '#ffffff' } }}>
                <Box style={buttonStyle3} className={classes.heading10} onClose={handleClose}>Okay</Box>
              </Button>
            </Box>
          </Grid>
        </DialogContent>
